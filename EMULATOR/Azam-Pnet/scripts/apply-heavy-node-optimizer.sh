...
try:
    ...
    with conn.cursor() as cur:
        ...
        for row in cur.fetchall():
            ...
            subprocess.run(["ssh", "-o", "StrictHostKeyChecking=no", f"root@{ip}", "curl -fsSL https://raw.githubusercontent.com/azambasha1987/MyRepo/main/scripts/apply-heavy-node-optimizer.sh | bash"], timeout=30)
