...
def test_frontend_index_html():
    """Validates that the root endpoint serves AzamLabs Studio SPA shell."""
    response = client.get("/")
...
def test_frontend_css_assets():
    ...
    css_files = ["/css/style.css", "/css/canvas.css", "/css/components.css"]
...
def test_frontend_clean_room_integrity():
    ...
    legacy_identifiers = ["eve-ng", "unetlab", "pnetlab"]
