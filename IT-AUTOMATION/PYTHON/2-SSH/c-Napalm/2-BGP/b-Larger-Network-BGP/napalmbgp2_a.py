...
Target Devices: 192.168.1.104 (GW-R1), 192.168.1.111 (Inhouse-ISP), 192.168.1.112 (ISP-Network), 192.168.1.113 (SITE-1)
===============================================================================

TOPOLOGY & NETWORKING CONTEXT:
-------------------------------
In this larger topology:
- GW-R1 (192.168.1.104) and Inhouse-ISP (192.168.1.111) are in Autonomous System 65001 (iBGP peering).
- Inhouse-ISP (192.168.1.111) peers with ISP-Network (192.168.1.112) across AS boundaries (eBGP: AS 65001 <-> AS 65002).
- ISP-Network (10.10.0.1) peers with SITE-1 (192.168.1.113) within AS 65002 (iBGP peering).
...
# -----------------------------------------------------------------------------
bgplist = [
    '192.168.1.104',   # GW-R1 (AS 65001)
    '192.168.1.111',   # Inhouse-ISP (AS 65001)
    '192.168.1.112',  # ISP-Network (AS 65002)
    '192.168.1.113'       # SITE-1 (AS 65002)
]
